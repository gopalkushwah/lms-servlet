...
<%
	...
	List<User> userList = UserDao.getAllUserByLimitAndOffset(itemsPerPage, (currentPage - 1) * itemsPerPage,"false","false");
...
<body>
	...
	<div id="mySidenav" class="sidenav">
		...
		<a href="admin.jsp" class="icon-a"><i
			class="fa fa-dashboard icons"></i> Dashboard</a> <a href="allLeads.jsp"
			class="icon-a"><i class="fa fa-line-chart icons"></i> All Leads</a> <a
			href="allUsers.jsp" class="icon-a"><i
			class="fa fa-user-plus icons"></i> All Users</a> <a
			href="adminProfile.jsp" class="icon-a"><i
			class="fa fa-user-circle icons"></i> Profile</a> <a href="adminHelp.jsp"
		...
		<div class="timeDate">
			<p
				style="margin-top: 375px; margin-left: 5px; font-size: 18px; color: gray;">Date
				and Time</p>
			<%
		...
		<div class="head">
			<div class="col-div-6">
				<span style="font-size: 30px; cursor: pointer; color: white;"
					class="nav"> All Users</span> <span
					style="font-size: 30px; cursor: pointer; color: white;"
					class="nav2"> All Users</span>
			</div>
						...
						<tbody>
							...
							%>
									<tr>
										...
										<td><%= u.getMobile() %></td>
										<td>
											<a class = 'btn btn-primary w-100' href="/Lead_Mangement_System/show-user-comments-by-admin.jsp?userid=<%= u.getId()%>">View</a>
										</td>
										<td>

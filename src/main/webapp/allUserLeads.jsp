...
<!Doctype HTML>
	...
	<head>
		...
		<!-- cdn for a table with pagination -->
...
<!--		Start Pagination -->
			<div>
			    <% if (currentPage > 1) { %>
			        <a class="btn btn-primary" style="padding: 2px 4px; text-decoration: none;" href="/Lead_Mangement_System/allUserLeads.jsp?page=<%= currentPage - 1 %>"> &lt; Previous</a>
			    <% } %>
			    <% if (currentPage < totalPages) { %>
			        <a class="btn btn-primary" style="padding: 2px 4px; text-decoration: none;" href="/Lead_Mangement_System/allUserLeads.jsp?page=<%= currentPage + 1 %>">Next &gt;</a>
			    <% } %>
			</div>

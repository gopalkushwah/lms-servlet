	...
	<br/><span>Total Leads</span></p>
		...
		<div class="col-12">
				...
				<div class="profile-img">
					...
					<%
						...
						try{
							...
							PreparedStatement pstmt2 = connect1.prepareStatement("select gender from users where email = ?");			
							pstmt2.setString(1, email2);
							ResultSet rst2 = pstmt2.executeQuery();
			
							while(rst2.next()) {
								gender = rst2.getString(1);	
							}
						...
						if(gender.equals("male")){
							out.print("<img src = 'image/male-av.jpg'");
						}else{
							out.print("<img src = 'image/female-av.jpg'");
						}
						%>
					<!-- <img src="image/profile image.png"  /> -->
										
					<div class = "heading">
						<p style = "margin-left: 1px;"><b>My Profile</b></p>
					</div>		
				</div>
			...
			<!-- 	<button type = "submit" id="myButton" class = "btnProfile"><i class="fa fa-camera icons editpf"></i></button> -->
				...
				%>
				<% try{
					String success = (String)session.getAttribute("imgStatus"); 
					if(success!= null){
						out.print("<div class='alert alert-danger alert-dismissible fade show alert1'>"+
									"<button type='button' class='close' data-dismiss='alert'>×</button>"+
		...
		<div class="container-fluid">
				...
				try{
							...
							PreparedStatement pstmt = connect1.prepareStatement("select name, email, mobile,gender from users where email = ?");			
							pstmt.setString(1, email);			
							ResultSet rst = pstmt.executeQuery();
				...
				<h3 style = "color: white;">Name : <%= name%></h3><br>
				<hr>
				<h3 style = "color: white;">Email :	<%= emailid %></h3><br>
				<hr>
				<h3 style = "color: white;">Mobile : <%= mobile %></h3><br>
				<hr>
				<h3 style = "color: white;">Gender : <%= gender %></h3><br>
				<hr>

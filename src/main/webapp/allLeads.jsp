	...
	<div class="clearfix"></div>
		...
		<div class="container-fluid">
			...
			<tr>
				...
				<td><%=lead.getDate() %></td>
				<td><%=lead.getOwner() %></td>
				<%if (lead.getPriority().equals("Low")){%>
					<td>
						<center>
							<div class = 'animated-progress progress-green'>
								<span data-progress='33'></span>
									Low
							</div>
						</center>
					</td>
				<%}if (lead.getPriority().equals("High")){%>
				<td>
						<center>
				...
				<%}if (lead.getPriority().equals("Medium")){%>
				<td>
						<center>
							<div class = 'animated-progress progress-purple'>
								<span data-progress='66'></span>
									Medium
							</div>
						</center>
					</td>
				...
				<td>
					<form action ='updateAdminAllLeads.jsp' method='post'>
						<button type='submit' class = 'btn btn-primary'  name = 'update' value = "<%= lead.getLeads_id()%>">Update</button>
					</form>
				</td>
				<td>
					<form action ='DeleteAdminLeads' method = 'post'>
						<button type='submit' class = 'btn btn-danger' name = 'delete' value = "<%= lead.getLeads_id() %>" onclick='myFunction()'>Delete</button>
					</form>
				</td>
				</tr>	
				<%} %>

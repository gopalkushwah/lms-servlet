...
<%
	...
	System.out.println(userCookie.getCompanyId());
			...
			<div class="boxform">
				...
				<form action = "UpdateAdminAllLeads" method = "post">
					<table>
						<tr>
							<td>Name </td>
							<td><input type = "text" name = "name" value = "<%= leadByLeadId.getName()%>"required/></td>
							<td>Email </td>
							<td><input type = "email" name = "email" value = "<%= leadByLeadId.getEmail()%>" readonly required/></td>
						</tr>
						<tr>
							<td>Address </td>
							<td><input type = "text" name = "address" value = "<%= leadByLeadId.getAddress()%>" required/></td>
							<td>Mobile </td>
							<td><input type = "tel" name = "mobile" maxlength= "10" value = "<%= leadByLeadId.getMobile()%>" required/></td>
						</tr>
						<tr>
							<td>Source </td>
							<td><input type = "text" name = "source" value = "<%= leadByLeadId.getSource()%>" required/></td>
							<td>Date </td>
							<td><input type = "date" name = "date" value = "<%= leadByLeadId.getDate()%>" required/></td>
						</tr>
						<tr>
							<td>Owner Email</td>
							...
							<td>
								...
								<input type = "email" name = "owner"  value = "<%= leadByLeadId.getOwner()%>"" readonly>
						
							</td>
							<td>Current Owner </td>
							<td>
							<select name = "currentOwner" required>
								<option selected disabled > <%= leadByLeadId.getCurrentowner()%></option>
								<%
											for(User x : userList){
								%>

			...
			<div class="boxheading">
				...
				<form action = "help" method = "post">
					<div  class = "getInTouch">
						<label>Name</label><br>
						<input type = "text" name = "name" placeholder = "Your name" value="<%= userCookie.getName()%>"/><br><br>
						<label>Email</label><br>
						<input type = "email" name = "email" placeholder = "Your email" value="<%= userCookie.getEmail()%>"/><br><br>
						<label>Mobile</label><br>
						<input type = "tel" name = "mobile" placeholder = "Your mobile" maxlength = "10" value="<%= userCookie.getMobile()%>"/><br><br>

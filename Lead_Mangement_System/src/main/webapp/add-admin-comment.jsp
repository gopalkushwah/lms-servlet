...
<body>
	...
	<div id="main">
		<div class="row d-flex mt-3">
			<div class="col-9">
				<span class="nav nav-heading"  > Add Comment</span>
				<span class="nav2 nav-heading"  > Add Comment</span>
			</div>
			<div class="col-3">
		...
		<div class="main-container">
				<form action="AddAdminComment" method="post" class="form-container mb-2 mt-2">

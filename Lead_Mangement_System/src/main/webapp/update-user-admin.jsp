...
<%
	...
	User user = UserDao.getUserByUserAndCompanyId(userId, userCookie.getUserId());
			...
			<form action = "UpdateUserByAdmin" method = "post">
				<div class="row p-3">
					...
					<div class="col-6 d-flex flex-column text-white">
						...
						<input class="form-control" type = "tel" name = "mobile" maxlength= "10" value="<%= user.getMobile()%>" required/>
					</div>
					<div class="col-6 d-flex flex-column text-white">

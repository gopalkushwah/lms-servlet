...
<%
	...
	int totalLeadCountCurrentOwner = LeadDao.getLeadsCountUsingCurrentOwner(userCookie.getEmail());
	int currentPage = (request.getParameter("page") != null) ? Integer.parseInt(request.getParameter("page")) : 1;
	int itemsPerPage = 10;
	int totalPages = (int) Math.ceil((double) totalLeadCountCurrentOwner / itemsPerPage);
	
	List<User> listUser = UserDao.getAllEmployeeByCompanyId(userCookie.getCompanyId());
	List<Lead> leadList = LeadDao.getAllLeadsByCurrentOwenerIdAndLimit(userCookie.getEmail(),itemsPerPage, (currentPage - 1) * itemsPerPage);
%>
<!Doctype HTML>
	<html>
	<head>
...
.logBtn:hover {
  ...
  background-color:#1b203d;
	...
	<div class="row d-flex mt-3">
			<div class="col-9">
				<span class="nav nav-heading"  > Current Lead</span>
				<span class="nav2 nav-heading"  > Current Lead</span>
			</div>
			<div class="col-3">
		...
		<div class="pe-2 ps-2">
			<p class="fs-2 text-white box-heading">Current Leads</p>
		</div>
		<hr class="divide">

...
<%
	...
	List<User> listUser = UserDao.getAllEmployeeByIsadminAndIssuperadmin("false", "false");
%>
<html>
<head>
		...
		<div class="main-container">
			<form action = "AddAdminBySuperAdmin" method = "post">
				<div class="row p-3">
					...
					<div class="col-12 mt-2 w-100 d-flex justify-content-center">
						<button type= "submit" class="submit-btn w-50 fw-bold">ADD ADMIN</button>
					</div>
				</div>
			</form>
		</div>
			...
			<form action = "AddUserBySuperAdmin" method = "post">
				<div class="row p-3">
					...
					<div class="col-6 d-flex flex-column text-white">
						...
						<input class="form-control" type = "text" name = "company-id" placeholder="Company Id" required/>
					</div>
					<div class="col-6 d-flex flex-column text-white">
					...
					<div class="col-12 mt-2 w-100 d-flex justify-content-center">
						<button type= "submit" class="submit-btn w-50 fw-bold">ADD USER</button>
					</div>
				</div>
			</form>
		</div>

...
<%
	...
	Lead lead = LeadDao.getLeadsByLeadId(leadId);
	...
	<span style="font-size:30px;cursor:pointer; color: white;" class="nav2"  > Update Lead</span>
		...
		<div class="col-12">
			<div class="boxform">
				...
				<% session.setAttribute("name", lead.getName()); %>
				...
				<form action = "updateMyLead" method = "post">
					<table>
						<tr>
							...
							<td>Email </td>
							<td><input type = "email" name = "email" value = "<%= lead.getEmail()%>" readonly required/></td>
						</tr>
						<tr>
							<td>Address </td>
						...
						<tr>
							...
							<select name = "priority" required>
								<option selected ><%= lead.getPriority()%></option>
								<option>Low</option>
